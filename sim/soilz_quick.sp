...
meas tran vptat_v avg v(vptat) from=3u to=5u
meas tran nbias_v avg v(nmos_bias) from=3u to=5u
meas tran pbias_v avg v(pmos_bias) from=3u to=5u
meas tran ota_v avg v(ota_out) from=3u to=5u
meas tran excout_v avg v(exc_out) from=3u to=5u
meas tran probep_v avg v(probe_p) from=3u to=5u
quit
.endc
.end
